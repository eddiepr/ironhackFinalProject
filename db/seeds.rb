...
Square.create(:game_id => 1, :x => 5, :y => 3, :contents => "bishop")
...
Square.create(:game_id => 1, :x => 5, :y => 4, :contents => "queen")
...
Square.create(:game_id => 3, :x => 1, :y => 1, :contents => "rook")
Square.create(:game_id => 3, :x => 2, :y => 1, :contents => "knight")
Square.create(:game_id => 3, :x => 3, :y => 1, :contents => "nil")
Square.create(:game_id => 3, :x => 4, :y => 1, :contents => "queen")
Square.create(:game_id => 3, :x => 5, :y => 1, :contents => "king")
Square.create(:game_id => 3, :x => 6, :y => 1, :contents => "bishop")
Square.create(:game_id => 3, :x => 7, :y => 1, :contents => "nil")
Square.create(:game_id => 3, :x => 8, :y => 1, :contents => "rook")

Square.create(:game_id => 3, :x => 1, :y => 2, :contents => "pawn")
Square.create(:game_id => 3, :x => 2, :y => 2, :contents => "pawn")
Square.create(:game_id => 3, :x => 3, :y => 2, :contents => "pawn")
Square.create(:game_id => 3, :x => 4, :y => 2, :contents => "pawn")
Square.create(:game_id => 3, :x => 5, :y => 2, :contents => "pawn")
Square.create(:game_id => 3, :x => 6, :y => 2, :contents => "pawn")
Square.create(:game_id => 3, :x => 7, :y => 2, :contents => "pawn")
Square.create(:game_id => 3, :x => 8, :y => 2, :contents => "pawn")
...
Square.create(:game_id => 3, :x => 2, :y => 4, :contents => "bishop")
...
Square.create(:game_id => 3, :x => 1, :y => 7, :contents => "pawn")
Square.create(:game_id => 3, :x => 2, :y => 7, :contents => "pawn")
Square.create(:game_id => 3, :x => 3, :y => 7, :contents => "pawn")
Square.create(:game_id => 3, :x => 4, :y => 7, :contents => "pawn")
Square.create(:game_id => 3, :x => 5, :y => 7, :contents => "pawn")
Square.create(:game_id => 3, :x => 6, :y => 7, :contents => "pawn")
Square.create(:game_id => 3, :x => 7, :y => 7, :contents => "pawn")
Square.create(:game_id => 3, :x => 8, :y => 7, :contents => "pawn")

Square.create(:game_id => 3, :x => 1, :y => 8, :contents => "rook")
Square.create(:game_id => 3, :x => 2, :y => 8, :contents => "knight")
Square.create(:game_id => 3, :x => 3, :y => 8, :contents => "bishop")
Square.create(:game_id => 3, :x => 4, :y => 8, :contents => "queen")
Square.create(:game_id => 3, :x => 5, :y => 8, :contents => "king")
Square.create(:game_id => 3, :x => 6, :y => 8, :contents => "bishop")
Square.create(:game_id => 3, :x => 7, :y => 8, :contents => "knight")
Square.create(:game_id => 3, :x => 8, :y => 8, :contents => "rook")
